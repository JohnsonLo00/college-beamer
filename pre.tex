...
% [zuel]   % 中南财经政法大学 (ZUEL)
% 
% [en]     % English, pls compile with pdfLaTeX 英语，请使用 pdfLaTeX 编译
% [zh]     % Chinese, automatically loads xeCJK and Chinese fonts, pls compile with XeLaTeX 中文，自动加载 xeCJK 包和中文字体，请使用 XeLaTeX 编译
%
% --- Example Usage ---
\usepackage[zuel,en]{collegebeamer}

% metadata
\title{Zhongnan University of Economics and Law Beamer Template}
...
\begin{frame}
    ...
    This template is released under the \bhref{https://creativecommons.org/licenses/by/4.0/legalcode}{Creative Commons CC BY 4.0 license}
\end{frame}
